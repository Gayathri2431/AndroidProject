 ...
 */
final class CameraBitmapLoadingWorkerTask extends AsyncTask<Void, Void, CameraBitmapLoadingWorkerTask.Result> {
    ...
    public CameraBitmapLoadingWorkerTask(CameraCropImageView cropImageView, Uri uri) {
        mUri = uri;
    ...
    protected Result doInBackground(Void... params) {
        try {
            if (!isCancelled()) {
                ...
                CameraBitmapUtils.BitmapSampled decodeResult =
                        CameraBitmapUtils.decodeSampledBitmap(mContext, mUri, mWidth, mHeight);

                if (!isCancelled()) {

                    CameraBitmapUtils.RotateBitmapResult rotateResult =
                            CameraBitmapUtils.rotateBitmapByExif(decodeResult.bitmap, mContext, mUri);
