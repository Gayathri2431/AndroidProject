 ...
 */
public class CameraCropImageView extends FrameLayout {
     ...
     */
    public final CameraCropOverlayView mCropOverlayView;
     ...
     */
    private CameraCropImageAnimation mAnimation;
     ...
     */
    private WeakReference<CameraBitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;

    /**
     * Task used to crop bitmap async from UI thread
     */
    private WeakReference<CameraBitmapCroppingWorkerTask> mBitmapCroppingWorkerTask;
    //endregion

    public CameraCropImageView(Context context) {
        this(context, null);
    }

    public CameraCropImageView(Context context, AttributeSet attrs) {
        super(context, attrs);

        CameraCropImageOptions options = null;
        Intent intent = context instanceof Activity ? ((Activity) context).getIntent() : null;
        if (intent != null) {
            options = intent.getParcelableExtra(CameraCropImage.CROP_IMAGE_EXTRA_OPTIONS);
        }

        if (options == null) {

            options = new CameraCropImageOptions();

            if (attrs != null) {
                TypedArray ta = context.obtainStyledAttributes(attrs, com.theartofdev.edmodo.cropper.R.styleable.CropImageView, 0, 0);
                try {
                    options.fixAspectRatio = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropFixAspectRatio, options.fixAspectRatio);
                    options.aspectRatioX = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioX, options.aspectRatioX);
                    options.aspectRatioY = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioY, options.aspectRatioY);
                    options.scaleType = ScaleType.values()[ta.getInt(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropScaleType, options.scaleType.ordinal())];
                    options.autoZoomEnabled = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAutoZoomEnabled, options.autoZoomEnabled);
                    options.multiTouchEnabled = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMultiTouchEnabled, options.multiTouchEnabled);
                    options.maxZoom = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMaxZoom, options.maxZoom);
                    options.cropShape = CropShape.values()[ta.getInt(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropShape, options.cropShape.ordinal())];
                    options.guidelines = Guidelines.values()[ta.getInt(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropGuidelines, options.guidelines.ordinal())];
                    options.snapRadius = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropSnapRadius, options.snapRadius);
                    options.touchRadius = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropTouchRadius, options.touchRadius);
                    options.initialCropWindowPaddingRatio = ta.getFloat(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropInitialCropWindowPaddingRatio, options.initialCropWindowPaddingRatio);
                    options.borderLineThickness = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderLineThickness, options.borderLineThickness);
                    options.borderLineColor = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderLineColor, options.borderLineColor);
                    options.borderCornerThickness = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderCornerThickness, options.borderCornerThickness);
                    options.borderCornerOffset = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderCornerOffset, options.borderCornerOffset);
                    options.borderCornerLength = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderCornerLength, options.borderCornerLength);
                    options.borderCornerColor = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderCornerColor, options.borderCornerColor);
                    options.guidelinesThickness = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropGuidelinesThickness, options.guidelinesThickness);
                    options.guidelinesColor = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropGuidelinesColor, options.guidelinesColor);
                    options.backgroundColor = ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBackgroundColor, options.backgroundColor);
                    options.showCropOverlay = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropShowCropOverlay, mShowCropOverlay);
                    options.showProgressBar = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropShowProgressBar, mShowProgressBar);
                    options.borderCornerThickness = ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropBorderCornerThickness, options.borderCornerThickness);
                    options.minCropWindowWidth = (int) ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMinCropWindowWidth, options.minCropWindowWidth);
                    options.minCropWindowHeight = (int) ta.getDimension(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMinCropWindowHeight, options.minCropWindowHeight);
                    options.minCropResultWidth = (int) ta.getFloat(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMinCropResultWidthPX, options.minCropResultWidth);
                    options.minCropResultHeight = (int) ta.getFloat(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMinCropResultHeightPX, options.minCropResultHeight);
                    options.maxCropResultWidth = (int) ta.getFloat(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMaxCropResultWidthPX, options.maxCropResultWidth);
                    options.maxCropResultHeight = (int) ta.getFloat(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMaxCropResultHeightPX, options.maxCropResultHeight);
                    options.flipHorizontally = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropFlipHorizontally, options.flipHorizontally);
                    options.flipVertically = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropFlipHorizontally, options.flipVertically);

                    mSaveBitmapToInstanceState = ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropSaveBitmapToInstanceState, mSaveBitmapToInstanceState);

                    // if aspect ratio is set then set fixed to true
                    if (ta.hasValue(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioX) &&
                            ta.hasValue(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioX) &&
                            !ta.hasValue(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropFixAspectRatio)) {
        ...
        View v = inflater.inflate(R.layout.crop_view, this, true);

        mImageView = (ImageView) v.findViewById(R.id.ImageView_image);
        mImageView.setScaleType(ImageView.ScaleType.MATRIX);

        mCropOverlayView = (CameraCropOverlayView) v.findViewById(R.id.CropOverlayView);
        mCropOverlayView.setCropWindowChangeListener(new CameraCropOverlayView.CropWindowChangeListener() {
            @Override
    ...
    public Rect getCropRect() {
        if (mBitmap != null) {
            ...
            return CameraBitmapUtils.getRectFromPoints(points, orgWidth, orgHeight,
    ...
    public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
        ...
        if (mBitmap != null) {
            ...
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                int orgWidth = mBitmap.getWidth() * mLoadedSampleSize;
                int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
                CameraBitmapUtils.BitmapSampled bitmapSampled =
                        CameraBitmapUtils.cropBitmap(getContext(), mLoadedImageUri, getCropPoints(),
                                mDegreesRotated, orgWidth, orgHeight,
                                mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                                reqWidth, reqHeight, mFlipHorizontally, mFlipVertically);
                croppedBitmap = bitmapSampled.bitmap;
            } else {
                croppedBitmap = CameraBitmapUtils.cropBitmapObjectHandleOOM(mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        mFlipHorizontally, mFlipVertically).bitmap;
            }

            croppedBitmap = CameraBitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
        }
    ...
    public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
        ...
        if (bitmap != null && exif != null) {
            CameraBitmapUtils.RotateBitmapResult result = CameraBitmapUtils.rotateBitmapByExif(bitmap, exif);
    ...
    public void setImageUriAsync(Uri uri) {
        if (uri != null) {
            CameraBitmapLoadingWorkerTask currentTask = mBitmapLoadingWorkerTask != null ? mBitmapLoadingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            mCropOverlayView.setInitialCropWindowRect(null);
            mBitmapLoadingWorkerTask = new WeakReference<>(new CameraBitmapLoadingWorkerTask(this, uri));
    ...
    public void rotateImage(int degrees) {
        if (mBitmap != null) {
            ...
            CameraBitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
            float halfWidth = (flipAxes ? CameraBitmapUtils.RECT.height() : CameraBitmapUtils.RECT.width()) / 2f;
            float halfHeight = (flipAxes ? CameraBitmapUtils.RECT.width() : CameraBitmapUtils.RECT.height()) / 2f;
            if (flipAxes) {
            ...
            CameraBitmapUtils.POINTS[0] = CameraBitmapUtils.RECT.centerX();
            CameraBitmapUtils.POINTS[1] = CameraBitmapUtils.RECT.centerY();
            CameraBitmapUtils.POINTS[2] = 0;
            CameraBitmapUtils.POINTS[3] = 0;
            CameraBitmapUtils.POINTS[4] = 1;
            CameraBitmapUtils.POINTS[5] = 0;
            mImageInverseMatrix.mapPoints(CameraBitmapUtils.POINTS);
            ...
            mImageMatrix.mapPoints(CameraBitmapUtils.POINTS2, CameraBitmapUtils.POINTS);
            mZoom /= Math.sqrt(Math.pow(CameraBitmapUtils.POINTS2[4] - CameraBitmapUtils.POINTS2[2], 2) + Math.pow(CameraBitmapUtils.POINTS2[5] - CameraBitmapUtils.POINTS2[3], 2));
            ...
            double change = Math.sqrt(Math.pow(CameraBitmapUtils.POINTS2[4] - CameraBitmapUtils.POINTS2[2], 2) + Math.pow(CameraBitmapUtils.POINTS2[5] - CameraBitmapUtils.POINTS2[3], 2));
            halfWidth *= change;
            halfHeight *= change;

            // calculate the new crop window rectangle to center in the same location and have proper width/height
            CameraBitmapUtils.RECT.set(CameraBitmapUtils.POINTS2[0] - halfWidth, CameraBitmapUtils.POINTS2[1] - halfHeight,
                    CameraBitmapUtils.POINTS2[0] + halfWidth, CameraBitmapUtils.POINTS2[1] + halfHeight);

            mCropOverlayView.resetCropOverlayView();
            mCropOverlayView.setCropWindowRect(CameraBitmapUtils.RECT);
            applyImageMatrix(getWidth(), getHeight(), true, false);
            handleCropWindowChanged(false, false);
     ...
     */
    void onSetImageUriAsyncComplete(CameraBitmapLoadingWorkerTask.Result result) {
     ...
     */
    void onImageCroppingAsyncComplete(CameraBitmapCroppingWorkerTask.Result result) {
    ...
    public void startCropWorkerTask(int reqWidth, int reqHeight, RequestSizeOptions options, Uri saveUri, Bitmap.CompressFormat saveCompressFormat, int saveCompressQuality) {
        if (mBitmap != null) {
            ...
            CameraBitmapCroppingWorkerTask currentTask = mBitmapCroppingWorkerTask != null ? mBitmapCroppingWorkerTask.get() : null;
            if (currentTask != null) {
            ...
            int orgHeight = mBitmap.getHeight() * mLoadedSampleSize;
            if (mLoadedImageUri != null && (mLoadedSampleSize > 1 || options == RequestSizeOptions.SAMPLING)) {
                mBitmapCroppingWorkerTask = new WeakReference<>(new CameraBitmapCroppingWorkerTask(this, mLoadedImageUri, getCropPoints(),
                        mDegreesRotated, orgWidth, orgHeight,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, mFlipHorizontally, mFlipVertically, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            } else {
                mBitmapCroppingWorkerTask = new WeakReference<>(new CameraBitmapCroppingWorkerTask(this, mBitmap, getCropPoints(), mDegreesRotated,
                        mCropOverlayView.isFixAspectRatio(), mCropOverlayView.getAspectRatioX(), mCropOverlayView.getAspectRatioY(),
                        reqWidth, reqHeight, mFlipHorizontally, mFlipVertically, options,
                        saveUri, saveCompressFormat, saveCompressQuality));
            }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        if (mSaveBitmapToInstanceState && imageUri == null && mImageResource < 1) {
            mSaveInstanceStateBitmapUri = imageUri = CameraBitmapUtils.writeTempStateStoreBitmap(getContext(), mBitmap, mSaveInstanceStateBitmapUri);
        }
        if (imageUri != null && mBitmap != null) {
            String key = UUID.randomUUID().toString();
            CameraBitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
            bundle.putString("LOADED_IMAGE_STATE_BITMAP_KEY", key);
        }
        if (mBitmapLoadingWorkerTask != null) {
            CameraBitmapLoadingWorkerTask task = mBitmapLoadingWorkerTask.get();
            if (task != null) {
        ...
        mImageMatrix.invert(mImageInverseMatrix);
        mImageInverseMatrix.mapRect(CameraBitmapUtils.RECT);

        bundle.putParcelable("CROP_WINDOW_RECT", CameraBitmapUtils.RECT);
        ...
        if (state instanceof Bundle) {
            ...
            if (mBitmapLoadingWorkerTask == null && mLoadedImageUri == null && mBitmap == null && mImageResource == 0) {
                ...
                if (uri != null) {
                    ...
                    if (key != null) {
                        Bitmap stateBitmap = CameraBitmapUtils.mStateBitmap != null && CameraBitmapUtils.mStateBitmap.first.equals(key)
                                ? CameraBitmapUtils.mStateBitmap.second.get() : null;
                        CameraBitmapUtils.mStateBitmap = null;
                ...
                if (newZoom > 0 && newZoom != mZoom) {
                    if (animate) {
                        if (mAnimation == null) {
                            ...
                            mAnimation = new CameraCropImageAnimation(mImageView, mCropOverlayView);
                        }
    ...
    private void applyImageMatrix(float width, float height, boolean center, boolean animate) {
        if (mBitmap != null && width > 0 && height > 0) {
            ...
            if (mDegreesRotated > 0) {
                mImageMatrix.postRotate(mDegreesRotated, CameraBitmapUtils.getRectCenterX(mImagePoints), CameraBitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }

            // scale the image to the image view, image rect transformed to know new width/height
            float scale = Math.min(width / CameraBitmapUtils.getRectWidth(mImagePoints), height / CameraBitmapUtils.getRectHeight(mImagePoints));
            if (mScaleType == ScaleType.FIT_CENTER || (mScaleType == ScaleType.CENTER_INSIDE && scale < 1) || (scale > 1 && mAutoZoomEnabled)) {
                mImageMatrix.postScale(scale, scale, CameraBitmapUtils.getRectCenterX(mImagePoints), CameraBitmapUtils.getRectCenterY(mImagePoints));
                mapImagePointsByImageMatrix();
            }
            ...
            mImageMatrix.postScale(scaleX, scaleY, CameraBitmapUtils.getRectCenterX(mImagePoints), CameraBitmapUtils.getRectCenterY(mImagePoints));
            mapImagePointsByImageMatrix();
            ...
            if (center) {
                ...
                mZoomOffsetX = width > CameraBitmapUtils.getRectWidth(mImagePoints) ? 0
                        : Math.max(Math.min(width / 2 - cropRect.centerX(), -CameraBitmapUtils.getRectLeft(mImagePoints)), getWidth() - CameraBitmapUtils.getRectRight(mImagePoints)) / scaleX;
                mZoomOffsetY = height > CameraBitmapUtils.getRectHeight(mImagePoints) ? 0
                        : Math.max(Math.min(height / 2 - cropRect.centerY(), -CameraBitmapUtils.getRectTop(mImagePoints)), getHeight() - CameraBitmapUtils.getRectBottom(mImagePoints)) / scaleY;
            } else {
    ...
    private void updateImageBounds(boolean clear) {
        if (mBitmap != null && !clear) {
            ...
            float scaleFactorWidth = mBitmap.getWidth() * mLoadedSampleSize / CameraBitmapUtils.getRectWidth(mImagePoints);
            float scaleFactorHeight = mBitmap.getHeight() * mLoadedSampleSize / CameraBitmapUtils.getRectHeight(mImagePoints);
    ...
    public interface OnSetImageUriCompleteListener {
         ...
         */
        void onSetImageUriComplete(CameraCropImageView view, Uri uri, Exception error);
    }
    //endregion
    ...
    public interface OnCropImageCompleteListener {
         ...
         */
        void onCropImageComplete(CameraCropImageView view, CropResult result);
    }
    //endregion
