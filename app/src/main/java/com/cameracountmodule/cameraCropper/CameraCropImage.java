...
public final class CameraCropImage {

    //region: Fields and Consts

    /**
     * The key used to pass crop image source URI to {@link CameraCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_SOURCE = "CROP_IMAGE_EXTRA_SOURCE";

    /**
     * The key used to pass crop image options to {@link CameraCropImageActivity}.
     */
    public static final String CROP_IMAGE_EXTRA_OPTIONS = "CROP_IMAGE_EXTRA_OPTIONS";

    /**
     * The key used to pass crop image result data back from {@link CameraCropImageActivity}.
     */
    ...
    /**
     * The request code used to start {@link CameraCropImageActivity} to be used on result to identify the this specific
     * request.
     */
    public static final int CROP_IMAGE_ACTIVITY_REQUEST_CODE = 203;

    /**
     * The result code used to return error from {@link CameraCropImageActivity}.
     */
    public static final int CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE = 204;
    //endregion

    private CameraCropImage() {
    }
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(context, context.getString(com.theartofdev.edmodo.cropper.R.string.pick_image_intent_chooser_title), false, true);
    }
     ...
     * {@link CameraCropImageActivity} to crop the selected image.<br>
    ...
    /**
     * Create {@link ActivityBuilder} instance to start {@link CameraCropImageActivity} to crop the given image.<br>
     * Result will be received in {@link Activity#onActivityResult(int, int, Intent)} and can be retrieved
     * using {@link #getActivityResult(Intent)}.
     *
    ...
    /**
     * Get {@link CameraCropImageActivity} result data object for crop image activity started using {@link #activity(Uri)}.
     *
    ...
    public static final class ActivityBuilder {
         ...
         */
        private final CameraCropImageOptions mOptions;

        private ActivityBuilder(@Nullable Uri source) {
            mSource = source;
            mOptions = new CameraCropImageOptions();
        }

        /**
         * Get {@link CameraCropImageActivity} intent to start the activity.
         */
        public Intent getIntent(@NonNull Context context) {
            return getIntent(context, CameraCropImageActivity.class);
        }
        ...
        /**
         * Start {@link CameraCropImageActivity}.
         *
         ...
         */
        public ActivityBuilder setCropShape(@NonNull CameraCropImageView.CropShape cropShape) {
         ...
         */
        public ActivityBuilder setGuidelines(@NonNull CameraCropImageView.Guidelines guidelines) {
         ...
         */
        public ActivityBuilder setScaleType(@NonNull CameraCropImageView.ScaleType scaleType) {
        ...
        /**
         * the title of the {@link CameraCropImageActivity}.<br>
         * <i>Default: ""</i>
         */
         ...
         * Uses {@link CameraCropImageView.RequestSizeOptions#RESIZE_INSIDE} option.<br>
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight) {
            return setRequestedSize(reqWidth, reqHeight, CameraCropImageView.RequestSizeOptions.RESIZE_INSIDE);
        }
         ...
         * <i>Default: 0, 0 - not set, will not resize</i>
         */
        public ActivityBuilder setRequestedSize(int reqWidth, int reqHeight, CameraCropImageView.RequestSizeOptions options) {
     ...
     */
    public static final class ActivityResult extends CameraCropImageView.CropResult implements Parcelable {
