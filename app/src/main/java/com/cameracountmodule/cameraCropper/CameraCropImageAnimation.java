 ...
 */
final class CameraCropImageAnimation extends Animation implements Animation.AnimationListener {

    //region: Fields and Consts

    private final ImageView mImageView;

    private final CameraCropOverlayView mCropOverlayView;
    ...
    public CameraCropImageAnimation(ImageView cropImageView, CameraCropOverlayView cropOverlayView) {
