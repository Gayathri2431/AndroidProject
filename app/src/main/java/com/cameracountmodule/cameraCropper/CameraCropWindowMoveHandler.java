 ...
 */
final class CameraCropWindowMoveHandler {
     ...
     */
    public CameraCropWindowMoveHandler(Type type, CameraCropWindowHandler cropWindowHandler, float touchX, float touchY) {
        mType = type;
