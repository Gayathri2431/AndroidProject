 ...
 */
public class CameraCropImageOptions implements Parcelable {

    public static final Creator<CameraCropImageOptions> CREATOR = new Creator<CameraCropImageOptions>() {
        @Override
        public CameraCropImageOptions createFromParcel(Parcel in) {
            return new CameraCropImageOptions(in);
        }

        @Override
        public CameraCropImageOptions[] newArray(int size) {
            return new CameraCropImageOptions[size];
        }
    };
     ...
     */
    public CameraCropImageView.CropShape cropShape;
     ...
     */
    public CameraCropImageView.Guidelines guidelines;

    /**
     * The initial scale type of the image in the crop image view
     */
    public CameraCropImageView.ScaleType scaleType;
   ...
   */
     ...
     */
    public CameraCropImageView.RequestSizeOptions outputRequestSizeOptions;
     ...
     */
    public CameraCropImageOptions() {

        DisplayMetrics dm = Resources.getSystem().getDisplayMetrics();

        cropShape = CameraCropImageView.CropShape.RECTANGLE;
        ...
        guidelines = CameraCropImageView.Guidelines.ON_TOUCH;
        scaleType = CameraCropImageView.ScaleType.FIT_CENTER;
        ...
        outputRequestSizeOptions = CameraCropImageView.RequestSizeOptions.NONE;
        noOutputImage = false;
     ...
     */
    protected CameraCropImageOptions(Parcel in) {
        cropShape = CameraCropImageView.CropShape.values()[in.readInt()];
        snapRadius = in.readFloat();
        touchRadius = in.readFloat();
        guidelines = CameraCropImageView.Guidelines.values()[in.readInt()];
        scaleType = CameraCropImageView.ScaleType.values()[in.readInt()];
        ...
        outputRequestSizeOptions = CameraCropImageView.RequestSizeOptions.values()[in.readInt()];
